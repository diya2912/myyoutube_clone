...
const Likewatchlatersavebtn = ({vv,vid}) => {
    ...
    const togglesavedvideo=()=>{
      ...
      const toggledislikedvideo=(e,lk)=>{
        if(currentuser){
            if(dislikebtn){
              setdislikebtn(false);
            }else{
  ...
  return (
    <div className="btns_cont_videoPage">
        ...
        <div className="btn_VideoPage">
            <div className="like_videoPage" onClick={(e)=>togglelikedvideo(e,vv.Like)}>
                {likebtn? (
                    <>
            ...
            <div className="like_videoPage" onClick={(e)=>toggledislikedvideo(e,vv.Like)}>
                {dislikebtn? (
                    <>
