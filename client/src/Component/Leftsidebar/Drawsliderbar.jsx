...
import { AiFillPlayCircle,AiOutlineHome,AiFillLike } from 'react-icons/ai';
import {MdOutlineExplore,MdOutlineSubscriptions,MdOutlineVideoLibrary,MdSubscriptions,MdOutlineWatchLater} from"react-icons/md";
import { FaHistory } from 'react-icons/fa';
import shorts from './shorts.png';
import { NavLink } from 'react-router-dom';


const Drawsliderbar = ({toggledrawer,toggledrawersidebar}) => {
  return (
        ...
        <div className="container2_DrawaerLeftSidebar">
            ...
            <div className="libraryBtn_Drawerleftsidebar">
                ...
                <NavLink to={'/Yourvideo'} className="icon_sidebar_div">
                    <p>
                        <AiFillPlayCircle size={22} className='icon_sidebar' style={{margin:"auto 0.7rem"}}/>
