...
import Drawsliderbar from './Component/Leftsidebar/Drawsliderbar';
...
function App() {
  ...
  const[editchanelbtn,seteditcreatechanelbtn]=useState(false);
  const[videouploadpage,setvideouploadpage] = useState(false);
  return (
    <Router>
      {videouploadpage && <Videoupload setvideouploadpage={setvideouploadpage}/>}
      {editchanelbtn && (<Createeditchannel seteditcreatechanelbtn={seteditcreatechanelbtn}/>)}
